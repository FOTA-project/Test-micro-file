...
void delay_ms(u32 time)
{
	...
	const u32 ctr = (u32)( (((f64)1000.0 * (f64)cpu_clock / (f64)8000000.0) * (f64)time - ((f64)189.0 + (f64)3.5)) / (f64)1.6248 );
...
void delay_us(u32 time)
{
   ...
   const u32 ctr = (u32)( (((f64)cpu_clock / (f64)8000000.0) * (f64)time - ((f64)189.0 + (f64)3.5)) / (f64)1.6248 );
